...
[_ADJUST] =  LAYOUT_ortho_4x12( \
  RESET,   _______, RGB_M_K, RGB_TOG,  _______, _______, _______, _______, _______, _______, _______, _______, \
  _______, RGB_HUI, RGB_MOD, RGB_RMOD, RGB_HUD, _______, _______, KC_ASRP, KC_ASDN, KC_ASUP, _______, _______, \
  _______, RGB_SAI, RGB_VAI, RGB_VAD,  RGB_SAD, _______, _______, _______, _______, _______, _______, _______, \
  _______, _______, _______, _______,  _______, _______, _______, _______, _______, _______, _______, _______ \
)
};
